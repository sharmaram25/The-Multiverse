  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        neon: "bg-transparent border border-green-500 text-green-500 hover:bg-green-500 hover:text-black shadow-[0_0_10px_rgba(34,197,94,0.5)] hover:shadow-[0_0_20px_rgba(34,197,94,0.8)]",
...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant, size, asChild = false, isLoading, children, ...props }, ref) => {
    ...
    // Apply custom styles for default variant based on theme variables
      ...
      <Comp
        ...
        onMouseEnter={(e: any) => {
          if (variant === 'default' && !props.disabled) {
            e.currentTarget.style.boxShadow = 'var(--btn-hover-shadow)';
            e.currentTarget.style.transform = 'var(--btn-transform)';
          }
